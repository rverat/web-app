      ...
      <div className="px-2 xl:px-4">
        <div className="-ml-4 -mt-2 hidden lg:flex flex-wrap items-center justify-between sm:flex-nowrap md:px-4 px-2">
          <Link to="/" className="ml-4 mt-2">
            <img src={python_logo} width={60} height={60} className="" />
          </Link>
          <div className="ml-4 mt-2 flex-shrink-0">
            ...
            <Link
              to="/login"
              className="inline-flex ml-12 items-center rounded-md border border-transparent bg-orange-600 px-6 py-3 text-base font-medium text-white shadow-sm hover:bg-gray-900 transition duration-300 ease-in-out focus:outline-none focus:ring-2 focus:ring-orange-500 focus:ring-offset-2"
            >
              Sing up
              <DotLoader
