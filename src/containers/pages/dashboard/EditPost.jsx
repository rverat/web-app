...
function EditPost({
  ...
  const { title, new_slug, description, category, time_read } = formData;
          ...
          <div className=" px-4 py-5 sm:px-6">
            <div className="-ml-4 -mt-4 flex flex-wrap items-center justify-between sm:flex-nowrap">
              <div className="ml-4 mt-4">
                ...
                <p className="mt-3 text-lg text-gray-500">{post.title}</p>
              </div>
              <div className="ml-4 mt-4 flex-shrink-0">
                ...
                >
                  {post.get_status === "published" ? <>Draft</> : <>Publish</>}
                </button>
              </div>
            </div>
          </div>
                  ...
                  {updateThumbnail ? (
                    <>
                      {previewImage && (
                        <img
                          src={previewImage}
                          className="object-cover w-80 h-72 p-4"
                        />
                      )}
                            ...
                            categories.map((category) => {
                              if (category.sub_categories.length === 0) {
                                ...
                                result.push(
                                  <div
                                    key={category.id}
                                    className="flex items-center h-5 mt-2"
                                  >
                                    <input
                                      onChange={(e) => onChange(e)}
                                      value={category.id.toString()}
                                ...
                                category.sub_categories.map((sub_category) => {
                                  result.push(
                                    <div
                                      key={sub_category.id}
                                      className="flex items-center h-5 ml-2 mt-1"
                                    >
                                      <input
                                        onChange={(e) => onChange(e)}
                          ...
                          <div className="mt-2">
                            ...
                            post.content ? (
                              ...
                              <p className="text-sm text-gray-500">
                                To publish this post you must add: Title,
                                Description, Slug and Content
                              </p>
                            )}
                          </div>
                        </div>
